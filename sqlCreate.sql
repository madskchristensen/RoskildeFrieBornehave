...
INSERT INTO child (first_name, last_name, class) VALUES
("John", "Williamford", 2),
("James", "Charlesford", 2),
("George", "Franksen", 2),
("Joseph", "Thomassen", 2),
...
("Samuel", "Davidsen", 3),
("Louis", "Joeford", 4),
("Charlie", "Clarenceford", 4),
("Richard", "Andrewford", 2),
("Daniel", "Ernestford", 4),
("Will", "Jesseford", 1),
("Oscar", "Lewisford", 1),
("Peter", "Benjaminford", 4),
("Frederick", "Williesen", 1),
("Alfred", "Samsen", 3),
("Roy", "Herbertford", 2),
("Jacob", "Tomsen", 2),
("Elmer", "Carlsen", 4),
("Lee", "Howardsen", 4),
("Martin", "Michaelford", 1),
("Bert", "Hermanford", 3),
("Jim", "Francisford", 4),
("Harvey", "Earlford", 3),
("Eugene", "Ralphford", 4),
...
("Lawrence", "Iraford", 2),
("Patrick", "Guysen", 4),
("Oliver", "Theodoresen", 1),
("Hugh", "Clydesen", 1),
("Alexander", "Augustford", 3),
("Floyd", "Homerford", 1),
("Jack", "Leonardsen", 4),
("Horace", "Marionford", 4),
("Philip", "Allensen", 1),
("Archie", "Stephenford", 2),
("Chester", "Willissen", 2),
("Raymond", "Rufusford", 1),
("Warren", "Jessiesen", 3),
("Milton", "Alexsen", 4),
